...
FIELD_EMAILFIELD = """{{f.slug_unicode}} = models.EmailField(
        '{{f.verbose_name}}', {% if f.help_text %}
        help_text='{{f.help_text}}', {% endif %}{% if f.choices %}
        choices={{f.choices_name}}, {% endif %}
        max_length={{f.max_length|valor}}, {% if f.is_blank %}
...
FIELD_FILEFIELD = """{{f.slug_unicode}} = models.FileField(
        '{{f.verbose_name}}', upload_to='{{f.slug_unicode}}', {% if f.help_text %}
        help_text='{{f.help_text}}', {% endif %}{% if f.choices %}
        choices={{f.choices_name}}, {% endif %}
        max_length={{f.max_length|valor}}, {% if f.is_blank %}
        blank=True, {% endif %}{% if f.is_null %}
...
FIELD_TYPES = {
    ...
    'FileField': FIELD_FILEFIELD,
    'EmailField': FIELD_EMAILFIELD,
}
