    ...
    for d in data_list:
        if len(d):
            ...
            try:
                ...
                print(colored('[dag_fields - Linha %s] Erro ao tentar localizar um Model(%s) com o "title" igual a %s' %
                              (d[0], d[1], dic['model_title']) , 'red'))
                return None

            if dic['fieldtype_title'] not in FIELD_TYPES:
                print(colored('[dag_fields - Linha %s] Erro ao tentar localizar um FieldType '
            ...
            if 'foreignkey_model_title' in dic:
                ...
                try:
                    ...
                    print(colored('[dag_fields - Linha %s] Erro ao tentar localizar um Model(%s) com o "foreignkey" igual a %s' %
            ...
            try:
                ...
                print(colored('[dag_fields - Linha %s] Erro ao salvar o Model(%s) campo duplicado, coluna slug com nome "%s"' %
