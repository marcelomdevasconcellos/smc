...
class ConveniosAditivos(BaseModel):
    cols = {
        'convenio': 6, 
        'data_assinatura': 6, 
        'data_publicacao': 6, 
    ...
    def __str__(self):
        return '{} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {}'.format(self.convenio, self.data_assinatura, self.data_publicacao, self.num_pagina_diario_oficial, self.data_inicio, self.vigencia, self.data_termino, self.num_documento, self.objeto, self.tipo, self.valor, self.valor_contrapartida, self.arquivo)
...
class ConveniosArquivos(BaseModel):
    cols = {
        'convenio': 6, 
        'nome_arquivo': 6, 
        'tipo': 6, 
    ...
    def __str__(self):
        return '{} - {} - {} - {} - {}'.format(self.convenio, self.nome_arquivo, self.tipo, self.descricao, self.arquivo)
...
class ConveniosContasControle(BaseModel):
    cols = {
        'convenio': 6, 
        'conta_controle': 6, }
    ...
    def __str__(self):
        return '{} - {}'.format(self.convenio, self.conta_controle)
...
class ConveniosCronogramaMensal(BaseModel):
    cols = {
        'ano': 6, 
        'convenio': 6, 
        'valor_jan': 6, 
    ...
    def __str__(self):
        return '{} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {} - {}'.format(self.ano, self.convenio, self.valor_jan, self.valor_fev, self.valor_mar, self.valor_abr, self.valor_mai, self.valor_jun, self.valor_jul, self.valor_ago, self.valor_set, self.valor_out, self.valor_nov, self.valor_dez)
...
class ConveniosDotacoes(BaseModel):
    cols = {
        'convenio': 6, 
        'orcamento': 6, 
        'dotacao': 6, 
    ...
    def __str__(self):
        return '{} - {} - {} - {}'.format(self.convenio, self.orcamento, self.dotacao, self.valor)
